...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyListPageThenGetPageWithVacancies() {
        var vacancy1 = new Vacancy(1, "1", "1", now(), true, 1, 2);
        var vacancy2 = new Vacancy(2, "2", "2", now(), false, 3, 4);
    ...
    public void whenPostVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "1", "1", now(), true, 1, 2);
    ...
    public void whenRequestVacancyByIdAndGetPageWithVacancyOne() {
        var expectedVacancies = new Vacancy(1, "1", "1", now(), true, 1, 2);
